...
| 仪表盘 | 会话 | 用量 |
|:------:|:----:|:----:|
| ![仪表盘](docs/screenshots/dashboard.png) | ![会话](docs/screenshots/sessions.png) | ![用量](docs/screenshots/usage.png) |

| 安全审计 | 主机监控 | 工具诊断 |
|:--------:|:--------:|:--------:|
| ![安全](docs/screenshots/security.png) | ![监控](docs/screenshots/monitoring.png) | ![工具](docs/screenshots/tools.png) |

| Agent 配置 | 模型与密钥管理 | Skill 管理 |
|:----------:|:------------:|:----------:|
| ![Agent 配置](docs/screenshots/instance-agents.png) | ![大模型](docs/screenshots/instance-models.png) | ![Skill](docs/screenshots/instance-skills.png) |
